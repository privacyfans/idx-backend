...
private httpOption = {
    ...
    // }
    create(news) {
        return this.http.post(`${environment.apiUrl}/vheadline`, news)
            .pipe(map(res => {
    ...
    update(news,id: number) {
        return this.http.put(`${environment.apiUrl}/vheadline/`+id, news)
            .pipe(map(res => {
    ...
    getAllList():Observable<any[]> {
        return this.http.get<any[]>(`${environment.apiUrl}/vheadline`);
      }
      delete(id: number) {
        return this.http.delete(`${environment.apiUrl}/vheadline/` + id);
      }

      getList(id: number):Observable<any[]> {
        return this.http.get<any[]>(`${environment.apiUrl}/vheadline/`+id);
      }
