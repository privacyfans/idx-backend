...
private httpOption = {
    ...
    // }
    create(news) {
        return this.http.post(`${environment.apiUrl}/vidnews`, news)
            .pipe(map(res => {
    ...
    update(news,id: number) {
        return this.http.put(`${environment.apiUrl}/vidnews/`+id, news)
            .pipe(map(res => {
    ...
    getAllList():Observable<any[]> {
        return this.http.get<any[]>(`${environment.apiUrl}/vidnews`);
      }
      delete(id: number) {
        return this.http.delete(`${environment.apiUrl}/vidnews/` + id);
      }

      getList(id: number):Observable<any[]> {
        return this.http.get<any[]>(`${environment.apiUrl}/vidnews/`+id);
      }
