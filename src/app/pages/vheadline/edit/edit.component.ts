...
export class vheadlineEditComponent implements OnInit, AfterViewInit{
...
constructor(
  ...
  updatevheadline() {
    console.log(this.vheadline.Id);
    if (this.formvheadline.valid) {
      this._vheadlineService.update(this.formvheadline.value,this.vheadline.Id).subscribe(res => {
